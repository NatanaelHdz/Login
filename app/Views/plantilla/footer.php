      ...
      <div class="tab-pane" id="control-sidebar-settings-tab">
        <form method="post">
          ...
          <div class="form-group">
            <label class="control-sidebar-subheading">
              sign out 
              <a href="<?php echo base_url('/salir')?>" class="text-red pull-right"><i class="fa fa-trash-o"></i></a>
            </label>
          </div>
          <!-- /.form-group -->
        </form>
...
<!-- ./wrapper -->
  ...
  <!-- Sparkline -->
  <script src="<?php echo base_url()?>/vendor/Admin/adminlte/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js"></script>
  <!-- jvectormap  -->
  <script src="<?php echo base_url()?>/vendor/Admin/adminlte/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
  ...
  <!-- ChartJS -->
  <script src="<?php echo base_url()?>/vendor/Admin/adminlte/bower_components/chart.js/Chart.js"></script>
  <!-- AdminLTE dashboard demo (This is only for demo purposes) -->
  <script src="<?php echo base_url()?>/vendor/Admin/adminlte/dist/js/pages/dashboard2.js"></script>
